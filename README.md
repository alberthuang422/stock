...
- **[MCD 单股 RSI 超卖买入·超卖分档](reports/47_MCD_RSI超卖分档买入/index.html)** · 39 号口径单股复刻（简化版，替代 46 号复杂支撑框架）：82 次下穿30 T+20 +1.83%/61.0%（t=2.06）但超额 vs SPY −0.51%（t=−0.81）——绝对收益有、超额为负，β 非 alpha；<b>分档：&lt;20 档 0 次（31.7 年从未深超卖）、20–25 档 n=4 绝对收益 +4.89% 但超额 −2.90% 且 n 过小、25–30 档 78 次 +1.68% ≈ 基率（无 edge）</b>；本轮牛市 10 次 T+20 −0.08% 策略失效；当前 RSI 44.4 非超卖不触发。95% 信号落在无 edge 的 25–30 档
