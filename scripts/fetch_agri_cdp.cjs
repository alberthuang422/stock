// 原生 CDP 抓取 Yahoo chart JSON：农业股 + ETF 批量拉数
// 标的：ADM BG MOS CF NTR CTVA AGCO FMC DAR FPI TSN HRL MOO DBA
const fs = require("fs");
const path = require("path");

const OUT_ROOT = path.resolve(__dirname, "../data");
const TICKERS = ["ADM", "BG", "MOS", "CF", "NTR", "CTVA", "AGCO", "FMC", "DAR", "FPI", "TSN", "HRL", "MOO", "DBA"];
