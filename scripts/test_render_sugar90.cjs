...
(async () => {
  ...
  const file = "file://" + path.resolve(__dirname, "../reports/90_白糖库消比与厄尔尼诺类比_20260912/index.html");
  ...
  const info = await page.evaluate(() => {
    ...
    return {
      ...
      d9n: (typeof DD !== "undefined" && DD.d9) ? DD.d9.length : 0,
      d10n: (typeof DD !== "undefined" && DD.d10) ? DD.d10.length : 0,
      d11n: (typeof DD !== "undefined" && DD.d11) ? DD.d11.length : 0,
    };
  });
