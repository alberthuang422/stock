# -*- coding: utf-8 -*-
"""
CCL RSI<30 细分下钻 —— 找"跌透后的最佳买点"（56 号延展）2026-09-01
目标: 在 RSI<30 的 79 次买入内，按 RSI 精数值 + 买入时回撤深度 + 反弹速度细分，
回答: 反弹迅速 / 反弹高度大的“好位置”是什么条件。
口径沿用 56 号: 日 freq adj_close, RSI(14) Wilder, 当日收盘 RSI 从更高区跌入 <30 触发,
...
新增维度:
  ...
  rsi   = 触发日 RSI 精值
输出 results/ccl_rsi_sub30_deep.json + 打印关键表
"""
...
out_path = os.path.join(OUT, "ccl_rsi_sub30_deep.json")
