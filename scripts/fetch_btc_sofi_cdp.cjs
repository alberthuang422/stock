// 通过本机 Chrome CDP 抓取 Yahoo chart API 数据：BTC-USD（2022-06 起，为 2023 年 60 日滚动留预热期）
const { chromium } = require("playwright-core");
const fs = require("fs");
const path = require("path");

const OUT_ROOT = path.resolve(__dirname, "../data");
const TICKERS = ["BTC-USD"];
const PERIOD1 = Math.floor(new Date("2022-06-01").getTime() / 1000);
