...
输出维度：
  ...
  4) 近 3 年 / 近 1 年子样本
输出 results/kbwb_med_weakness.json；控制台打汇总 KPI。
"""
import os
import json
import math
...
def main():
    ...
    out = {
        ...
        "meta": {"kbwb": "Invesco KBW Bank ETF（银行指数代理）",
                 "techs": {"XPH": "SPDR Pharmaceuticals ETF（化学制药/传统药企）", "XBI": "SPDR Biotech ETF（生物制药/生物科技）"},
    ...
    path = os.path.join(OUT, "kbwb_med_weakness.json")
