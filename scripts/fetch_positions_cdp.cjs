// 原生 CDP 抓取 Yahoo chart JSON：刷新持仓+K线参考（2026-08-28）
// 持仓：CSCO/MCD/VST/APO/ABBV/GILD（多）+ SBUX/XYZ（空仓观望）
// 参考：SPY QQQ XLF XLV XLK XLP XLE XLRE XLU
const fs = require("fs");
const path = require("path");

const OUT_ROOT = path.resolve(__dirname, "../data");
const TICKERS = ["CSCO", "MCD", "VST", "APO", "ABBV", "GILD", "SBUX", "XYZ",
  "SPY", "QQQ", "XLF", "XLV", "XLK", "XLP", "XLE", "XLRE", "XLU"];
