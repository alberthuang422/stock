...
const htmlPath = path.join(__dirname, '..', 'reports', '25_工具业绩传导时滞', 'index.html');
...
async function main() {
  ...
  const needTxt = ['传导时滞', '3-4 个季度', '17.3%', '2026Q4-2027', 'WAT 2026 并表', 'Veralto',
                   'A 安捷伦', 'WAT 沃特世', 'DHR 丹纳赫', 'TMO 赛默飞', '口径警示', '有机口径'];
