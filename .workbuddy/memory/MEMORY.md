...
- **【08-23 再追加·五年对比+口径辨析】补 2022/2023 → 五年序列 2022 -4 低迷 / 2023 -1 筑底 / 2024 +8 / 2025 -1 / 2026 +9（深 V 修复）**。**重要方法论修正——口径辨析：16 项清单主体=大型制药（销售/盈利驱动），≠ XBI 小型纯 Biotech 景气（融资→并购→临床数据驱动）**。量化证据：XBI 年度收益 vs 并购金额相关系数 0.494（n=5，本地日线）；脱钩实证 2022 XBI -25.9% vs XPH -9.8%、2024 XBI +1.0% vs +4.9%（大药企 GLP-1 跑赢）、2025/2026 并购年 XBI 反超。XBI 景气打分（并购视角）：2022 -1/2023 +1/2024 0/2025 +1/2026 +1，2024 与 16 项（+8）方向分歧=脱钩实证。报告 7 章节含「口径辨析」（chart_xbi 双轴图），129 来源链接。
