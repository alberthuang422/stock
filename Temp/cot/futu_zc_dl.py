...
rpc("initialize", {"protocolVersion": "2025-03-26", "capabilities": {}, "clientInfo": {"name": "zc-dl", "version": "1"}})
rpc("notifications/initialized", {}, notify=True)
time.sleep(0.4)

def page(end):
    r = rpc("tools/call", {"name": "quote_history_kline",
                           "arguments": {"symbol": "US.ZCmain", "ktype": "2", "end": end, "num": "370"}})
...
json.dump(uni, open("zc_main_hist.json", "w"))
