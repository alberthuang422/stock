...
A = {
 ...
 "72_CFTC农产品持仓_20260901": ("ag","series","keep","COT 全量持仓全景（含 73-75 删除前的上游数据）"),
 "76_中期选举窗口波动率合集": ("q_tm","active","keep","合集：37/38/42 中期选举三份合体（原文归档）"),
 "77_MCD_RSI低吸系列合集": ("q_rsi","active","keep","合集：46-49 MCD RSI 四连合体（原文归档）"),
 "78_银行弱势传导合集_KBWB": ("c_bank","active","keep","合集：14/15/16 KBWB 弱势三份合体（原文归档）"),
 # ---- 顶层散件 ----
