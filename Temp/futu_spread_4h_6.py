...
rpc("initialize", {"protocolVersion": "2025-03-26", "capabilities": {}, "clientInfo": {"name": "h4x6", "version": "1"}})
...
json.dump(out, open(os.path.join(BASE, "results", "futu_spread_4h_6legs_raw.json"), "w", encoding="utf-8"),
          ensure_ascii=False, indent=1)
print("saved -> results/futu_spread_4h_6legs_raw.json")
